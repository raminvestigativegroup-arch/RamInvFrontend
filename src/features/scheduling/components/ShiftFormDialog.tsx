        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col flex-1 min-h-0">
              ...
              <FormField label="Guards" required error={errors.selectedGuards}>
                ...
                >
                  {form.selectedGuards.length === 0 ? (
                    <span className="text-muted-foreground">Click to assign guards...</span>
                  ) : (
                    ...
                    <div className="flex gap-2 mb-4">
                      ...
                      {filteredGuards.length > 0 && (
                        <button
                          ...
                          className="px-3 h-[38px] bg-secondary hover:bg-secondary/70 border border-border rounded-lg text-xs font-semibold active:scale-95 transition-all"
                        >
            ...
            <DialogFooter>
              ...
              <Button type="submit" loading={isLoadingSave}>
