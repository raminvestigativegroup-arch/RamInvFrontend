    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex border-b border-border gap-2">
        <button
          ...
          className={`px-4 py-2.5 text-sm font-semibold border-b-2 transition-all ${activeTab === "list"
        ...
        <button
          ...
          className={`px-4 py-2.5 text-sm font-semibold border-b-2 transition-all ${activeTab === "summary"
              ? "border-primary text-primary"
              : "border-transparent text-muted-foreground hover:text-foreground"
            }`}
        >
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-secondary border border-border rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
        </div>
      </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2 p-1 bg-secondary/50 rounded-xl border border-border">
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-all ${uploadUserType === "Guard" ? "bg-background text-foreground shadow" : "text-muted-foreground hover:text-foreground"
                    }`}
                >
                  Guard
                </button>
                <button
                  ...
                  className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-all ${uploadUserType === "Manager" ? "bg-background text-foreground shadow" : "text-muted-foreground hover:text-foreground"
                    }`}
                >
                  Manager
                </button>
